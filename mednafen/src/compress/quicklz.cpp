...
static INLINE uint32 fast_read(void const *src, uint32 bytes)
{
#ifndef x86x64_only
...
static INLINE void fast_write(uint32 f, void *dst, uint32 bytes)
{
#ifndef x86x64_only
...
static INLINE void memcpy_up(char *dst, const char *src, uint32 n)
{
...
static INLINE uint32 fast_read_safe(void const *src, uint32 bytes, const char *invalid)
{
#ifdef memory_safe 
