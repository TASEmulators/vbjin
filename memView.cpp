...
static const MemViewRegion s_wramRegion = { "WRAM", 0x05000000, 0x10000 };
static const MemViewRegion s_dramRegion = { "DRAM", 0x00200000, 0x20000 };
...
uint8_t memRead8 (RegionType regionType, HWAddressType address)
{
	...
	{
	case MEMVIEW_WRAM:
		return *(MDFN_IEN_VB::getWRAM() + (address - region.hardwareAddress));
	case MEMVIEW_DRAM:
		return *(MDFN_IEN_VB::getDRAM() + (address - region.hardwareAddress));
	}
	return 0;
}
...
uint16_t memRead16 (RegionType regionType, HWAddressType address)
{
	...
	{
	case MEMVIEW_WRAM:
		return *(uint16_t*)(MDFN_IEN_VB::getWRAM() + (address - region.hardwareAddress));
	case MEMVIEW_DRAM:
		return *(uint16_t*)(MDFN_IEN_VB::getDRAM() + (address - region.hardwareAddress));
	}
	return 0;
}
...
uint32_t memRead32 (RegionType regionType, HWAddressType address)
{
	...
	{
	case MEMVIEW_WRAM:
		return *(uint32_t*)(MDFN_IEN_VB::getWRAM() + (address - region.hardwareAddress));
	case MEMVIEW_DRAM:
		return *(uint32_t*)(MDFN_IEN_VB::getDRAM() + (address - region.hardwareAddress));
	}
	return 0;
}
...
void memWrite8 (RegionType regionType, HWAddressType address, uint8_t value)
{
	...
	{
	case MEMVIEW_WRAM:
		*(MDFN_IEN_VB::getWRAM() + (address - region.hardwareAddress)) = value;
		break;
	case MEMVIEW_DRAM:
		*(MDFN_IEN_VB::getDRAM() + (address - region.hardwareAddress)) = value;
		break;
	}
}
...
void memWrite16 (RegionType regionType, HWAddressType address, uint16_t value)
{
	...
	{
	case MEMVIEW_WRAM:
		*(uint16_t*)(MDFN_IEN_VB::getWRAM() + (address - region.hardwareAddress)) = value;
		break;
	case MEMVIEW_DRAM:
		*(uint16_t*)(MDFN_IEN_VB::getDRAM() + (address - region.hardwareAddress)) = value;
		break;
	}
}
...
void memWrite32 (RegionType regionType, HWAddressType address, uint32_t value)
{
	...
	{
	case MEMVIEW_WRAM:
		*(uint32_t*)(MDFN_IEN_VB::getWRAM() + (address - region.hardwareAddress)) = value;
		break;
	case MEMVIEW_DRAM:
		*(uint32_t*)(MDFN_IEN_VB::getDRAM() + (address - region.hardwareAddress)) = value;
		break;
	}
}
	...
	, selNewVal(0x00000000)
{
	...
	{
		s_memoryRegions.push_back(s_wramRegion);
		s_memoryRegions.push_back(s_dramRegion);
	}
